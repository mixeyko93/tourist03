...
router.add_api_route("/search", pages_service.public_search_page, methods=["GET"], response_class=HTMLResponse)
router.add_api_route("/collections/{slug}", pages_service.public_collection_page, methods=["GET"], response_class=HTMLResponse)
router.add_api_route("/routes/{slug}", pages_service.public_route_page, methods=["GET"], response_class=HTMLResponse)
router.add_api_route("/nearby", pages_service.public_nearby_page, methods=["GET"], response_class=HTMLResponse)
...
router.add_api_route("/owner", pages_service.react_map_page, methods=["GET"], response_class=HTMLResponse)
router.add_api_route("/owner/{path:path}", pages_service.react_map_page, methods=["GET"], response_class=HTMLResponse)
...
router.add_api_route("/map", pages_service.public_map_page, methods=["GET"], response_class=HTMLResponse)
