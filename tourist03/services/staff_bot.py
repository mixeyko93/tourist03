...
def build_staff_start_text() -> str:
    ...
    return (
        ...
        "Чтобы привязать учётку:\n"
        "1. В CRM → Настройки → карточка сотрудника → «Привязать Telegram».\n"
        "2. Появится QR-код — сфотографируйте экран и <b>отправьте фото сюда</b>.\n"
        "   Или нажмите «📷 Сканировать QR» ниже и наведите камеру на QR.\n\n"
        "Команды:\n"
