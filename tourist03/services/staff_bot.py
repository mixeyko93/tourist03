...
def build_staff_start_text() -> str:
    return (
        ...
        "Это бот уведомлений CRM Tourist_03. Здесь вы будете получать уведомления о новых заявках, сменах и важных событиях.\n\n"
        "🔗 <b>Привязка аккаунта:</b>\n"
        "1. Откройте CRM → <b>Настройки</b>\n"
        "2. Найдите свою карточку → нажмите <b>«Привязать Telegram»</b>\n"
        "3. Появится <b>6-значный код</b> — просто отправьте его сюда в чат\n\n"
        "Готово — бот автоматически привяжет вашу учётку."
    )
