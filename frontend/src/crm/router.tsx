  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { path: "collections", lazy: lazyComponent(() => import("./admin/pages/AdminCollectionsPage")) },
        { path: "collections/new", lazy: lazyComponent(() => import("./admin/pages/AdminCollectionEditPage")) },
        { path: "collections/:id", lazy: lazyComponent(() => import("./admin/pages/AdminCollectionEditPage")) },
        { path: "routes", lazy: lazyComponent(() => import("./admin/pages/AdminRoutesPage")) },
        { path: "routes/new", lazy: lazyComponent(() => import("./admin/pages/AdminRouteEditPage")) },
        { path: "routes/:id", lazy: lazyComponent(() => import("./admin/pages/AdminRouteEditPage")) },
