  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <div className="relative flex flex-1 overflow-hidden">
        <div className={`relative shrink-0 transition-[width] duration-300 ${sidebarOpen ? "w-56" : "w-0"}`}>
          <aside
        ...
        <main className="crm-ambient relative flex-1 overflow-y-auto px-4 py-6 md:px-6 lg:px-8">
