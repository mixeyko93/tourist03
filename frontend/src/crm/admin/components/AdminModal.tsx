      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            className={`flex max-h-[95dvh] w-full max-w-4xl flex-col overflow-hidden rounded-3xl border border-border bg-card shadow-2xl ${panelClassName}`.trim()}
          ...
          >
            <div className="flex shrink-0 items-start justify-between gap-4 border-b border-border px-5 py-4 sm:px-6">
              ...
              <button type="button" onClick={onClose} className="admin-icon-button" title="Закрыть" aria-label="Закрыть">
                <X className="h-4 w-4" />
              </button>
            </div>
